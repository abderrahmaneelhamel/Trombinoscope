...
import Trombinoscope from '@/pages/Trombinoscope.vue'
import cdo from '@/pages/cdo.vue'
import df from '@/pages/df.vue'
import dosi from '@/pages/dosi.vue'
import programmesSi from '@/pages/programmesSi.vue'
