            ...
            <div
                ...
                <div class="text-center text-sm text-gray-500 sm:text-left">
                    <div class="flex items-center">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="-mt-px w-5 h-5 text-gray-500"
                            viewBox="0 0 24 24"
                            stroke-width="2"
                            stroke="currentColor"
                            fill="none"
                        ...
                        <a
                            href="https://www.linkedin.com/in/faisalfajri"
                        ...
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            class="ml-4 -mt-px w-5 h-5 text-gray-500"
                            viewBox="0 0 24 24"
                            stroke-width="2"
                            stroke="currentColor"
                            fill="none"
                        ...
                        <a
                            href="https://github.com/faisalfjri"
                            class="ml-1 underline font-medium">
                            Github
                        </a>
                    </div>
                ...
                <div
                    class="ml-4 text-center text-sm text-gray-500 sm:text-right sm:ml-0 font-medium">
                    Laravel Breeze + Vue.js 3 template
                </div>
            </div>
        </div>
    </div>
